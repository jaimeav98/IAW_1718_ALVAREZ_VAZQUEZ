...
CREATE TABLE `gusta` (
  ...
  KEY `fk2` (`Matricula`),
  CONSTRAINT `gusta_ibfk_1` FOREIGN KEY (`DNI`) REFERENCES `usuario` (`DNI`),
  CONSTRAINT `gusta_ibfk_2` FOREIGN KEY (`Matricula`) REFERENCES `vehiculo` (`Matricula`)
...
INSERT INTO `gusta` VALUES ('53712051J','3334-JKZ');
